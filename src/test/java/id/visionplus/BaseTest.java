...
public class BaseTest {
	...
	public void ConfigureAppium() throws InterruptedException, IOException {
		...
		options.setChromedriverExecutable(System.getProperty("user.dir") + "/src/test/java/id/visionplus/Assets/chromedriver.exe");
		options.setApp(System.getProperty("user.dir") + "/src/test/java/id/visionplus/Assets/visionplus.apk");
