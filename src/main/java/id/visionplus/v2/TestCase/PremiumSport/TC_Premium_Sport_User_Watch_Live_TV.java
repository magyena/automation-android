...
public class TC_Premium_Sport_User_Watch_Live_TV extends BaseTest{
	...
	@Test(dependsOnMethods="TC_Premium_Sport_User_Watch_Free_Linear")
	public void TC_Premium_Sport_User_Watch_Premium_Linear() throws IOException, InterruptedException, TimeoutException {
	...
	@Test(dependsOnMethods="TC_Premium_Sport_User_Watch_Premium_Linear")
	public void TC_Premium_Sport_User_Watch_Premium_Sport_Linear() throws IOException, InterruptedException, TimeoutException {
		Scroll scroll = new Scroll(android);
