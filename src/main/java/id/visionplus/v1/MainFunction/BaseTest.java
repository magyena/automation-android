package id.visionplus.v1.MainFunction;
...
public class BaseTest {
	...
	public void ConfigureAppium() throws InterruptedException, IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/id/visionplus/Resources/data.properties");
		prop.load(fis);		
		...
		options.setChromedriverExecutable(System.getProperty("user.dir") + "/src/main/java/id/visionplus/Assets/chromedriver.exe");
		options.setApp(System.getProperty("user.dir") + "/src/main/java/id/visionplus/Assets/bss.apk");
