...
import id.visionplus.v1.PageObjects.GamesPlusMenuPage;
...
import id.visionplus.v1.PageObjects.MenuFooterPage;
import id.visionplus.v1.PageObjects.MenuHeaderPage;
import id.visionplus.v1.PageObjects.PengaturanPage;
import id.visionplus.v1.PageObjects.SportPageVisionPlus;
import id.visionplus.v1.PageObjects.TvKuPageVisionPlus;
import id.visionplus.v1.PageObjects.VODPage;
import id.visionplus.v1.PageObjects.VplusOriPage;
...
public class Click extends BaseTest {
	...
	public void scrollToElement(WebElement element) {
		...
		touchAction.longPress(ElementOption.element(element)).moveTo(ElementOption.element(element)).release()
				.perform();
